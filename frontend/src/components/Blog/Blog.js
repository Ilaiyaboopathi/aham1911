          ...
          <div className="space-y-8">
            ...
            {/* Newsletter Widget */}
             {/* <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-6 shadow-soft text-white"
            >
              <div className="flex items-center space-x-2 mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg mb-3 text-gray-900 focus:ring-2 focus:ring-white/50 transition-all"
              />
              <button className="w-full bg-white text-primary-600 hover:bg-primary-50 px-4 py-3 rounded-lg font-semibold transition-all duration-300">
                Subscribe Now
              </button>
            </motion.div> */}
          </div>
