...
import { CheckCircle, User, Briefcase, DollarSign, Ruler , FileText, Globe, Star, Shield, Home, RefreshCcwIcon, BadgeCheckIcon } from "lucide-react";
import { 
  HomeIcon, 
  CurrencyRupeeIcon, 
  ClockIcon, 
...
const benefits = [
  {
    ...
    description: "Reduce your monthly EMIs by transferring your existing loan to AHAM at competitive rates."
  },
  {
    icon: BanknotesIcon,
    title: "Top-Up Facility Available",
    description: "Get additional funds for home improvement, extension, or construction if eligible."
  },
  {
    icon: ClockIcon,
    title: "Flexible Tenure up to 20 Years",
    description: "Restructure your repayment tenure to match your financial comfort."
  },
  {
    icon: ShieldCheckIcon,
    title: "Quick and Secure Transfer",
    description: "Fast approval and seamless coordination with your existing lender for smooth takeover."
  },
  {
    icon: ChartBarIcon,
    title: "FOIR & LTV as per Home Loan Norms",
    description: "Balanced and responsible funding aligned with AHAM’s financial assessment standards."
  },
  {
    icon: BadgeCheckIcon,
    title: "No Hidden Charges",
    description: "Transparent processing with clear guidelines on fees, documentation, and timelines."
  }
];
 ...
 const eligibility = [
  "Minimum existing loan vintage of 12 months with the current lender",
  "Property must be fully constructed or under construction for not more than 12 months",
  "Loan amount eligibility based on income, FOIR norms, and repayment capacity",
...
const icons = [
 ...
 const documents = {
  ...
  nri: [
    ...
    "Overseas employment contract and salary proof",
...
const faqs = [
  {
    ...
    answer:
      "A Balance Transfer Loan allows you to transfer your existing home loan from another lender to AHAM Housing Finance to enjoy better interest rates and improved repayment terms."
  },
  {
    question: "Can I get a top-up loan along with balance transfer?",
    answer:
      "Yes. Subject to eligibility, you may get additional funding for home improvement, extension, or construction."
  },
  {
    question: "What is the minimum loan vintage required for transfer?",
    answer:
      "A minimum of 12 months of repayment with the existing lender is required for balance transfer eligibility."
  },
  {
    question: "Is balance transfer allowed for plot loans?",
    answer:
      "No. Plot-only loans are not eligible unless immediate construction is planned and initiated."
  },
  {
    question: "What are the loan tenure options?",
    answer:
      "The repayment tenure ranges from 1 year to 20 years depending on eligibility and loan category."
  },
  {
    question: "What are the FOIR and LTV norms?",
    answer:
      "FOIR is generally capped at 50%, and LTV is applied based on the underlying home loan norms."
  },
  {
    question: "What documents are required from my existing lender?",
    answer:
      "A no-dues certificate, loan account statement, original property documents list, and foreclosure letter are required during takeover."
  }
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[650px] overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: 'url(img/loan-banners/Balance-Transfer-Loan.webp)',
          }}
        >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            Reduce your EMI burden and enjoy better loan terms by transferring your existing home loan to AHAM Housing Finance. Our
            <strong> Balance Transfer Loan </strong>
            helps you move your outstanding principal from another financial institution to AHAM with the option to avail a top-up for construction, extension, or home improvements.
          </p>

          {/* <p>
            With quick processing, competitive interest rates, and simple documentation, we ensure a smooth and hassle-free transition aligned with your financial goals.
          </p> */}

          <ul className="space-y-3">
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Loan from ₹5 lakhs to ₹25 lakhs</strong> – Designed for both mid-size and large outstanding amounts.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Tenure up to 20 years</strong> – Allows better EMI planning and long-term affordability.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Minimum 12-month loan vintage</strong> – Ensures stability and eligibility for takeover.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Top-up available for construction/renovation</strong> – Additional funds for your home improvement needs.</span>
            </li>
          </ul>
        </div>
      </motion.div>
      ...
      >
        <img
           src="img/loan-overview/balance-transfer-loan.webp"
          alt="Balance Transfer Overview"
...
export default BalanceTransferLoan;