...
const benefits = [
  {
    ...
    description: "Get financing between ₹10 lakhs and ₹50 lakhs for ready or under-construction homes."
  },
  {
    icon: ClockIcon,
    title: "Tenure up to 15 Years",
    description: "Repay comfortably with flexible loan tenures designed for NRI salaried professionals."
  },
  {
    icon: ChartBarIcon,
    title: "Competitive & Transparent Rates",
    description: "Enjoy attractive interest rates with clear, simple repayment options."
  },
  {
    icon: ShieldCheckIcon,
    title: "Exclusively for Salaried NRIs",
    description: "Loans offered only to salaried NRIs for added security and income stability."
  },
  {
    icon: CurrencyRupeeIcon,
    title: "Easy Repayment Channels",
    description: "Repay via normal banking channels or through NRE/NRO accounts with ease."
  },
  {
    icon: HomeIcon,
    title: "Approved Projects Only",
    description: "Financing available for ready or under-construction properties from approved builders."
  }
];
...
const eligibility = [
  "Applicant must hold a valid Indian passport and NRI status",
  "Minimum 1 year of continuous overseas employment",
  "Minimum monthly net salary of ₹80,000 credited in bank",
...
const documents = {
  common: [
    ...
    "Address Proof – Aadhaar, Passport, Utility Bills, Rent Agreement, etc.",
    "Date of Birth Proof – Passport, PAN, Driving License, Birth Certificate"
  ],
  ...
  nri: [
    "Valid Indian passport and overseas visa",
  ...
  property: [
    ...
    "Approved building plan and property valuation report",
    "Legal and technical appraisal reports",
 ...
 const faqs = [
  {
    question: "Can I avail a loan for constructing a house on my own plot?",
    answer:
      "Yes, AHAM offers Home Construction Loans with flexible repayment options of up to 20 years for customers building on self-owned land."
  },
  {
    question: "What is a composite loan and who should opt for it?",
    answer:
      "A composite loan finances both land purchase and subsequent home construction. It is ideal for customers who want a single loan instead of taking separate loans for the plot and construction."
  },
  {
    question: "Are NRIs eligible for home loans?",
    answer:
      "Yes, salaried NRIs working in approved countries can apply for home loans with AHAM, subject to eligibility criteria and document verification."
  },
  {
    question: "What is the maximum loan amount available?",
    answer:
      "Eligible NRI salaried applicants can avail up to ₹50 lakhs for ready or under-construction homes."
  },
  {
    question: "Is there any prepayment or foreclosure penalty?",
    answer:
      "Prepayment and foreclosure charges may apply as per AHAM’s policy. Loans can be closed fully or partially with applicable charges."
  },
  {
    question: "How is the loan amount determined?",
    answer:
      "Loan eligibility depends on income stability, repayment capacity, credit score, property valuation, and LTV guidelines."
  },
  {
    question: "What are the age limits for applying?",
    answer:
      "Minimum age at loan application is 21 years. Maximum age at loan maturity is 60 years or the applicant’s retirement age."
  }
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[650px] overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: 'url(img/loan-banners/NRI-loan.webp)',
          }}
        >
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
             Own a Home in India with AHAM NRI Home Loan
            </h1>
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Specially designed for salaried NRIs—simple documentation, flexible tenure, and secure funding for your Indian property.
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            As a Non-Resident Indian, investing in a home back in India is more than a financial decision — it’s a personal milestone. AHAM Housing Finance offers dedicated 
            <strong> Home Loans for Salaried NRIs </strong> designed specifically to help you buy ready-to-move or under-construction residential properties from approved developers.
          </p>

          {/* <p>
            With trusted processes, transparent terms, and flexible repayment options, we make your journey to owning a home in India simple, secure, and seamless.
          </p> */}
          ...
          <ul className="space-y-3">
            <li className="flex items-start space-x-3">
              ...
              <span>
                <strong>Loan amounts from ₹10 lakhs to ₹50 lakhs</strong> – Designed for NRI salaried profiles and approved properties.
              </span>
            </li>
            ...
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 flex-shrink-0 mt-1" />
              <span>
                <strong>Repayment tenure up to 15 years</strong> – Choose a tenure that fits your long-term financial goals.
              </span>
            </li>
            ...
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 flex-shrink-0 mt-1" />
              <span>
                <strong>Repayment through NRE/NRO accounts</strong> – Hassle-free EMI payments from overseas income.
              </span>
            </li>
            ...
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 flex-shrink-0 mt-1" />
              <span>
                <strong>Exclusive for Salaried NRIs</strong> – Ensures stable income verification and streamlined approval.
              </span>
            </li>
          </ul>
        </div>
      ...
      >
        <img
          src="img/loan-overview/NRI-loan.webp"
          alt="NRI Home Loan Overview"
