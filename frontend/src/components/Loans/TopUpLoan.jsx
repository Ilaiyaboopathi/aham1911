    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[650px] overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: 'url(img/loan-banners/Top-up-loan.webp)',
          }}
        >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            Need extra funds without the hassle of applying for a new loan? AHAM Housing Finance offers 
            <strong> Top-Up Loans </strong>
            exclusively for existing home loan customers who have maintained a healthy repayment track.
          </p>

          <p>
            Whether you want to renovate your home, manage medical expenses, fund your business, or cover education costs, a top-up loan gives you additional financial flexibility with minimal documentation.
          </p>

          <ul className="space-y-3">
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Additional funding up to ₹25 lakhs</strong> – Based on repayment track and property value.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Tenure up to 15 years</strong> – Flexible EMIs to suit your needs.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Lower rates than personal loans</strong> – Affordable and convenient funding.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Minimal documentation</strong> – Quick processing for eligible customers.</span>
            </li>
          </ul>
        </div>
      </motion.div>
      ...
      >
        <img
          src="img/loan-overview/Top-up-loan.webp"
          alt="Top-Up Loan Overview"
