...
import { CheckCircle, User, Briefcase, DollarSign, Ruler , FileText, Globe, Star, Shield, Home ,WrenchIcon, SettingsIcon, BadgeCheckIcon} from "lucide-react";
import { 
  HomeIcon, 
  CurrencyRupeeIcon, 
  ClockIcon, 
...
const benefits = [
  {
    icon: WrenchIcon,
    title: "Loan up to ₹15 Lakhs",
    description: "Finance all types of internal and external home improvements including painting, plumbing, electrical work, tiling, and roofing."
  },
  {
    icon: ClockIcon,
    title: "Flexible Tenure up to 20 Years",
    description: "Choose repayment options that comfortably align with your financial capacity."
  },
  {
    icon: HomeIcon,
    title: "For Self-Owned Residential Property",
    description: "Loan available exclusively for improving your self-owned or self-occupied property."
  },
  {
    icon: SettingsIcon,
    title: "Structural & Non-Structural Work Covered",
    description: "Supports repairs such as waterproofing, grills, compound walls, aluminum windows, and more without increasing built-up area."
  },
  {
    icon: ShieldCheckIcon,
    title: "Transparent & Competitive Rates",
    description: "Fixed or floating interest rates linked to AHFL Benchmark Reference Rate with clear, upfront charges."
  },
  {
    icon: BadgeCheckIcon,
    title: "Quick Processing & Simple Documentation",
    description: "Fast approval based on income stability and property ownership, with minimal paperwork."
  }
];
 ...
 const eligibility = [
  "Applicant must be the owner of the property being renovated",
  "Available for Salaried, Self-Employed, and Business Owners",
  "Income and credit evaluation as per standard AHAM norms",
  "Age requirement: Minimum 21 years at loan origination",
  "Maximum age at loan maturity: 60 years (salaried) / 65 years (self-employed)",
  "Property must have clear title and be located within serviceable limits"
];
...
const documents = {
  common: [
    "Completed loan application form with passport-size photographs",
  ...
  property: [
    ...
    "Previous sale deed and tax receipts",
    "Renovation estimate / work order / contractor quotation",
    "Photographs of existing condition (if requested)"
  ]
};
 ...
 const faqs = [
  {
    ...
    answer:
      "A Home Renovation Loan helps you fund repairs, maintenance, and structural improvements to your existing self-owned property without increasing its built-up area."
  },
  {
    question: "What type of renovations are allowed?",
    answer:
      "Painting, plumbing, electrical upgrades, tiling, waterproofing, grills, compound walls, roofing, and other structural repairs are eligible under the loan."
  },
  {
    question: "What is the maximum loan amount I can get?",
    answer:
      "Loan amounts range from ₹5 lakhs to ₹15 lakhs depending on income, eligibility, and renovation estimate."
  },
  {
    question: "What is the maximum tenure for repayment?",
    answer:
      "Loan tenure ranges from 1 year up to 20 years, allowing flexible EMI options."
  },
  {
    question: "What is the maximum Loan-to-Value for renovation loans?",
    answer:
      "The maximum LTV permitted for Home Renovation Loans is up to 60% of the property value."
  },
  {
    question: "What interest rates apply?",
    answer:
      "Loans are offered at fixed or floating interest rates linked to the AHFL Benchmark Reference Rate. Processing fees and commitment charges apply as per policy."
  },
  {
    question: "How does repayment work?",
    answer:
      "Repayment is through monthly EMIs on a reducing balance basis. Pre-EMI interest is charged until full disbursement."
  }
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[650px] overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: 'url(img/loan-banners/Renovation-loan.webp)',
          }}
        >
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          ...
          >
            ...
            Upgrade Your Living Space with AHAM Home Renovation Loan
            </h1>
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              From painting to plumbing, get easy financing to modernize and enhance your home—your way.
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            Your home deserves care, upgrades, and improvements that keep it beautiful, functional, and safe. AHAM Housing Finance offers a dedicated
            <strong> Home Renovation Loan </strong>
            to help you improve your existing self-owned residential property—without the need to increase its living space.
          </p>

          {/* <p>
            Whether it’s waterproofing, painting, electrical upgrades, plumbing work, tiling, roofing, or external repairs, our loan lets you transform your home with flexible funding and quick approvals.
          </p> */}

          <ul className="space-y-3">
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Loan from ₹5 lakhs to ₹15 lakhs</strong> – Perfect for small to medium scale renovation projects.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Tenure up to 20 years</strong> – Flexible EMIs to match your financial comfort.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Maximum LTV of 60%</strong> – Funding based on property value and renovation scope.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Covers internal & external repairs</strong> – Improve your home without expanding built-up area.</span>
            </li>
          </ul>
        </div>
      </motion.div>
      ...
      >
        <img
        src="img/loan-overview/renovation-loan.webp"
          alt="Home Improvement Loan Overview"
