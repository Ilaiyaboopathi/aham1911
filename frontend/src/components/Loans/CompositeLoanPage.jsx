...
const HomeCompositeLoan = () => {
 ...
 const benefits = [
  {
    icon: BanknotesIcon,
    title: 'Loan up to ₹25 Lakhs',
    description: 'Finance both plot purchase and home construction under a single loan.'
  },
  {
    icon: ClockIcon,
    title: 'Long Tenure up to 20 Years',
    description: 'Choose flexible repayment options that align with your long-term financial plans.'
  },
  {
    icon: ChartBarIcon,
    title: 'Single Loan for Plot & Construction',
    description: 'Avoid managing multiple loans with a seamless combined financing structure.'
  },
  {
    icon: ShieldCheckIcon,
    title: 'Disbursement Linked to Construction',
    description: 'Funds released as per verified construction stages for transparent utilisation.'
  },
  {
    icon: CurrencyRupeeIcon,
    title: 'Attractive Interest Rates',
    description: 'Competitive rates designed to make land purchase and construction affordable.'
  },
  {
    icon: HomeIcon,
    title: 'End-to-End Support',
    description: 'From legal checks to technical assessments, we assist at every step of the journey.'
  }
];
...
const eligibility = [
  'Applicant must plan to complete construction within 3 years of loan approval',
  'Age between 21 and 65 years at the time of loan maturity',
  'Available for Salaried, Self-Employed, and Business Professionals',
  'Stable income and repayment capacity as per AHAM’s credit policy',
  'Clear land title with no legal disputes',
  'Approved building plan and construction estimate required',
  'Good credit history preferred, subject to CIBIL check',
  'Both plot purchase and construction must meet regulatory guidelines'
];
...
const icons = [
 ...
 const documents = {
  ...
  nri: [
    ...
    'Employment Contract / Income Proof Abroad',
    'Power of Attorney (if applicable)',
    'OCI/PIO Card (if applicable)'
  ],

  property: [
    'Sale Agreement / Registered Sale Deed for the Plot',
    'Approved Building Plan & Construction Cost Estimate',
 ...
 const faqs = [
  {
    question: 'What is a Composite Loan?',
    answer:
      'A Composite Loan finances both the purchase of a residential plot and the construction of a house on it. It combines two needs into one single loan.'
  },
  {
    question: 'Is a Composite Loan different from a regular home loan?',
    answer:
      'Yes. A regular home loan is used for buying a ready property, whereas a Composite Loan covers both plot purchase and construction.'
  },
  {
    question: 'Can I apply for only the land portion?',
    answer:
      'No. Composite Loans are specifically for plot plus construction. If you need only land finance, AHAM offers dedicated land loan options.'
  },
  {
    question: 'Are the loan funds released in stages?',
    answer:
      'Yes. Disbursements are made in stages based on verified construction milestones through technical inspections.'
  },
  {
    question: 'What is the eligibility for a Composite Loan?',
    answer:
      'Eligibility is based on income stability, credit score, repayment capacity, property documents, and construction timeline.'
  },
  {
    question: 'What documents are required?',
    answer:
      'KYC, income documents, property papers, approved building plan, cost estimate, and technical/legal reports are required.'
  },
  {
    question: 'Can I construct on inherited or gifted land?',
    answer:
      'Yes, provided you have clear ownership documents and all property approvals are in place.'
  },
  {
    question: 'What is the repayment structure?',
    answer:
      'Interest is charged only on the amount disbursed. Full EMI begins after the final disbursement, similar to a construction loan.'
  },
  {
    question: 'Does AHAM offer a Composite Loan EMI calculator?',
    answer:
      'Yes. The Composite Loan EMI calculator helps you estimate monthly EMIs based on loan amount, tenure, and interest rates.'
  }
];
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            At AHAM Housing Finance, we understand that building your dream home begins with choosing the perfect plot and transforming it into a space you can proudly call your own. Our <strong>Composite Loan</strong> helps you finance both the <strong>purchase of a residential plot</strong> and the <strong>construction of your home</strong> — all under a single loan.
          </p>

          {/* <p>
            With simplified documentation, flexible tenure options, and stage-wise disbursement, our composite loan ensures a smooth and stress-free experience throughout your home-building journey.
          </p> */}
          ...
          <ul className="space-y-3">
            <li className="flex items-start space-x-3">
              ...
              <span>
                <strong>Single loan for plot + construction</strong> – No need to manage multiple loans or repayment schedules.
              </span>
            </li>
            ...
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 flex-shrink-0 mt-1" />
              <span>
                <strong>Flexible repayment up to 20 years</strong> – Choose tenure that suits your financial plan.
              </span>
            </li>
            ...
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 flex-shrink-0 mt-1" />
              <span>
                <strong>Stage-wise disbursement</strong> – Loan released as per construction progress for transparent fund usage.
              </span>
            </li>
            ...
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 flex-shrink-0 mt-1" />
              <span>
                <strong>Easy documentation & faster processing</strong> – Combined process for both land and construction approval.
              </span>
            </li>
          </ul>
        </div>
...
export default HomeCompositeLoan;