...
import { CheckCircle, User, Briefcase, DollarSign, Ruler , FileText, Globe, Star, Shield, Home, ExpandIcon, BadgeCheckIcon } from "lucide-react";
import { 
  HomeIcon, 
  CurrencyRupeeIcon, 
  ClockIcon, 
...
const benefits = [
  {
    ...
    description: "Finance additional rooms or extended living areas to increase your home’s comfort."
  },
  {
    icon: ExpandIcon,
    title: "Expand Your Existing Space",
    description: "Add bedrooms, study rooms, reading corners, balconies, or utility areas as per your needs."
  },
  {
    icon: ClockIcon,
    title: "Flexible Tenure up to 20 Years",
    description: "Choose a repayment schedule that fits your long-term financial plan."
  },
  {
    icon: ChartBarIcon,
    title: "Construction-Linked Disbursement",
    description: "Funds released based on approved project milestones and technical progress."
  },
  {
    icon: ShieldCheckIcon,
    title: "Maximum LTV up to 60%",
    description: "Get financial support based on the current property value and extension cost."
  },
  {
    icon: BadgeCheckIcon,
    title: "Minimal Documentation & Quick Approval",
    description: "Fast and smooth processing for eligible homeowners with clear property ownership."
  }
];
 ...
 const eligibility = [
  "Applicant must be the legal owner of the existing residential unit",
  "Available for Salaried, Self-Employed, and Business Professionals",
  "Age: 21 years minimum at loan origination",
...
const icons = [
 ...
 const documents = {
  ...
  property: [
    "Ownership documents of existing house",
 ...
 const faqs = [
  {
    ...
    answer:
      "A Home Extension Loan provides financial support to expand your existing home by adding new rooms or additional living space."
  },
  {
    question: "What kind of extensions are allowed?",
    answer:
      "Extensions such as extra bedrooms, study rooms, reading spaces, balconies, utility areas, and small expansions are allowed as long as they comply with local building norms."
  },
  {
    question: "What is the maximum loan amount available?",
    answer:
      "You can avail a loan amount between ₹5 lakhs and ₹15 lakhs depending on eligibility and property valuation."
  },
  {
    question: "What is the maximum LTV for extension loans?",
    answer:
      "Up to 60% LTV based on the value of the existing property and extension estimate."
  },
  {
    question: "How does loan disbursement work?",
    answer:
      "Disbursement is linked to construction progress and released in stages as per technical inspection."
  },
  {
    question: "Do I need to own the existing house?",
    answer:
      "Yes. The applicant must be the owner of the existing residential unit where the extension is planned."
  },
  {
    question: "What is the repayment tenure?",
    answer:
      "The loan tenure ranges from 1 year to a maximum of 20 years."
  }
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[650px] overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: 'url(img/loan-banners/Extension-loan.webp)',
          }}
        >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            As your family grows, your living space should grow with it. AHAM Housing Finance offers a
            <strong> Home Extension Loan </strong>
            to help you add extra rooms or expand your living area without the need to relocate.
          </p>

          {/* <p>
            Whether you want an additional bedroom, a reading nook, a study room, or a cozy coffee corner, our loan gives you the flexibility and support to enhance your home with ease.
          </p> */}

          <ul className="space-y-3">
            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Loan from ₹5 lakhs to ₹15 lakhs</strong> – Ideal for mid-size home expansion projects.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Tenure up to 20 years</strong> – Flexible EMI options for long-term convenience.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Construction-linked disbursement</strong> – Funds released as per project progress.</span>
            </li>

            <li className="flex items-start space-x-3">
              <CheckCircleIcon className="h-6 w-6 text-primary-600 mt-1" />
              <span><strong>Maximum LTV of 60%</strong> – Loan value aligned with your property valuation.</span>
            </li>
          </ul>
        </div>
      </motion.div>
      ...
      >
        <img
          src="img/loan-banners/Extension-loan.webp"
...
export default HomeExtensionLoan;