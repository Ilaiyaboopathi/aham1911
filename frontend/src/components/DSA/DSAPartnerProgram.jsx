...
<section className="py-20 bg-gray-50">
  <div className="container mx-auto px-4">
    ...
    >
      ...
      <section id="become-partner" className="relative py-24 overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url('/img/ahamlife/Team-collaboration.webp')"
          }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-primary-900/95 to-primary-700/95"></div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            ...
            <p className="text-2xl text-white/90 mb-10 max-w-3xl mx-auto">
              Start earning by helping families get affordable home loans
            </p>
            ...
            <div className="max-w-2xl mx-auto bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-white">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="font-semibold">partners@ahamhfc.com</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <MapPinIcon className="h-8 w-8" />
                  <p className="text-sm opacity-80">Serving</p>
                  <p className="font-semibold text-sm">TN, KA, TG & AP</p>
                </div>
              </div>
            </div>
          </motion.div>
